...
public class ItemsContract  {
    ...
    public class ItemsEntity implements BaseColumns {
        ...
        public static final String SQL_CREATE_ITEMS = "CREATE TABLE " + TABLE_NAME_ITEMS + " ( " + _ID +
                ...
                + " TEXT, " + COLUMN_NAME_ITEM_PICTURE + " BLOB, " + COLUMN_NAME_ITEM_CODE + " BLOB, " +
                COLUMN_NAME_ITEM_CREATION_DATE + " TEXT, " + COLUMN_NAME_USER_EMAIL_ITEMS + " TEXT, "+ COLUMN_NAME_BP_ID+" INTEGER DEFAULT 0)";
